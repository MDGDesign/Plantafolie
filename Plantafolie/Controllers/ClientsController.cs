...
namespace Plantafolie.Controllers
{
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClientId,Prenom,Nom,Adresse,Ville,Province,Pays,Telephone,Cellulaire,MotDePasse,Courriel")] Client client)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClientId,Prenom,Nom,Adresse,Ville,Province,Pays,Telephone,Cellulaire,MotDePasse,Courriel")] Client client)
        {
